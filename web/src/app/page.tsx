        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex gap-3 mt-8">
            <Link
              ...
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground font-display font-bold text-label tracking-[0.15em] uppercase px-6 py-3 h-11 hover:bg-scarlet-dim transition-colors no-underline"
            >
              View Golf Intelligence <ArrowRight className="size-3.5" />
            </Link>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 border border-border text-muted-foreground font-display font-bold text-label tracking-[0.15em] uppercase px-6 py-3 h-11 hover:border-primary hover:text-primary transition-colors no-underline"
            >
              Get in Touch
            </Link>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-px bg-border border border-border">
            ...
            <div className="md:col-span-3 bg-card p-8 md:p-10 flex flex-col">
              <p className="font-mono text-label tracking-[0.25em] uppercase text-primary mb-3">
              ...
              <p className="font-mono text-label tracking-[0.2em] uppercase text-primary mt-auto pt-6">
            ...
            <div className="md:col-span-5 bg-surface p-8 md:px-10 md:py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <p className="font-mono text-label tracking-[0.25em] uppercase text-primary mb-2">
                  03 — Resources
                </p>
              ...
              <Link
                href="/resources"
                className="inline-flex items-center gap-2 font-mono text-label tracking-[0.12em] uppercase text-muted-foreground hover:text-primary transition-colors no-underline shrink-0"
              >
            ...
            {TIGER_5.map(({ num, label, icon: Icon }) => (
              <div key={num} className="bg-card p-5 flex flex-col items-start gap-3">
                <div className="flex items-center gap-3">
                  <span className="font-mono text-label tracking-[0.2em] text-primary">{num}</span>
