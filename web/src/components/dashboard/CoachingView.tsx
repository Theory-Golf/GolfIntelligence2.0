...
export function CoachingView({ metrics }: { metrics: CoachTableMetrics }) {
  ...
  const columns = [
    ...
    { key: 'dropOffPct', label: 'Drp%', isPercent: true, invertPercent: true, alwaysTotal: true },
    { key: 'gasPedalPct', label: 'Gas%', isPercent: true, alwaysTotal: true },
    { key: 'bogeyTrainPct', label: 'Trn%', isPercent: true, invertPercent: true, alwaysTotal: true },
    { key: 'totalStrokesGained', label: 'SG', isSG: true },
    { key: 'sgDriving', label: 'SG Drv', isSG: true },
    { key: 'penaltyRate', label: 'Pnl%', isPercent: true, invertPercent: true, alwaysTotal: true },
                    ...
                    return (
                      <td
                        ...
                        style={{
                          ...
                          fontSize: column.isPlayer ? '13px' : '12px',
                        }}
                      >
